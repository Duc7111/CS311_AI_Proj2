...
class World:
    ...
    def isBorder(self, x: int, y: int, exiting: bool) -> bool: # x, y is position base on the position of agent
        ...
        return (pos_x not in range(0, self.n) or pos_y not in range(0, self.n))
